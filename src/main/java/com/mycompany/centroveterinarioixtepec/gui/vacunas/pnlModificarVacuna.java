...
public class pnlModificarVacuna extends javax.swing.JPanel {

    Controller control = null;
    Vacunacion vacunacion = null;
    pnlVacunas pnlVacunas = null;
    JPanel pnlPrincipal = null;
    String mascota = null;

    public pnlModificarVacuna(int idRegistro, JPanel pnlPrincipal, String mascota) {
    ...
    private void initComponents() {
        ...
        proxVacunacion = new com.toedter.calendar.JDateChooser();
        ...
        proxVacunacion.setBackground(new java.awt.Color(255, 255, 255));
        proxVacunacion.setForeground(new java.awt.Color(102, 102, 102));
        proxVacunacion.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 18)); // NOI18N
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(proxVacunacion, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(proxVacunacion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(3, 3, 3)
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        control.modificarVacunacion(vacunacion, txtVacuna.getText(), txtDosis.getText(), txtPeso.getText(), txtTemperatura.getText());

        pnlVacunas = new pnlVacunas(pnlPrincipal);
        pnlVacunas.mostrarMensaje("Registro modificado correctamente", "info", "Modificacion de registro");
        
        cambiarPanel(pnlVacunas);
    ...
    private void cargarDatos(int idRegistro) {
        ...
        this.vacunacion = control.traerVacunacion(idRegistro);

        txtMascota.setText(mascota);
        txtVacuna.setText(vacunacion.getNombreVacuna());
        txtDosis.setText(String.valueOf(vacunacion.getDosis()));
        txtPeso.setText(String.valueOf(vacunacion.getPeso()));
        txtTemperatura.setText(String.valueOf(vacunacion.getTemperatura()));
        
        String fechaOriginal = vacunacion.getFechaProxVacunacion();
    ...
    private com.toedter.calendar.JDateChooser proxVacunacion;
